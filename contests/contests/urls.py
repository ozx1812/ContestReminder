...
from users.views import MyProfileView,ProfileUpdateView,SignUpView,SignInView,LogOutView
...
urlpatterns = [
    ...
    path('myprofileupdate/',ProfileUpdateView.as_view(),name='profieupdate'),
